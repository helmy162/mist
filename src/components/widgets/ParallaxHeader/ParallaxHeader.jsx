    ...
    >
      <Layout col="1">
        <section className="about" id="about">
          ...
          <div  className="fade">
            <div class="card2 user" style={{height:'fit-content'}}>
              <span class="inner-card-backface" style={{background:'transparent'}}>
                <span class="flip-inner-card">
                </span>
              </span>
              <span class="inner-card" style={{background:'transparent'}}>
          ...
          <img className="dragon" src={dragon} alt="Computer man"/>
            ...
            <div className="about-buttons" style={{display:'flex', flexDirection:'row', alignItems: 'center', justifyContent: 'center', gap:'20px', flexWrap:'wrap'}}>
